...
func Effect(team, _pos): # When some other defense card uses the special give +1 attack and +1 health to all your card on the field and reduce by 1 the cost of 1 card in your hand
